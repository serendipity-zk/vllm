...
class EplbModelState:
    ...
    model_name: str
    model_role: str
    """Alignment ownership of these counts: target or draft."""
    max_forwards_per_step: int
    """Maximum model forwards contributing to one EngineCore step."""
            ...
            for expert_load_pass, eplb_model_state in zip(
                ...
                if ep_group.rank() == 0:
                    ...
                    alignment_record = {
                        ...
                        "max_forwards_per_step": eplb_model_state.max_forwards_per_step,
